...
namespace cpu {
	...
	void CPU::LD_HL_R8(CPU::Register8* r) { /* TODO */ }
	void CPU::LD_HL_N8(u8 n) {}
	void CPU::LD_R8_HL(CPU::Register8* r) {}
	void CPU::LD_R16_A(CPU::Register16* r) {}
	void CPU::LD_N16_A(u16 n) {}
	void CPU::LDH_N16_A(u16 n) {}
	void CPU::LDH_C_A(int c) {}
	void CPU::LD_A_R16(CPU::Register16* r) {}
	void CPU::LD_A_N16(u16 n) {}
	void CPU::LDH_A_N16(u16 n) {}
	void CPU::LDH_A_C(int c) {}
	void CPU::LD_HLI_A() {}
	void CPU::LD_HLD_A() {}
	void CPU::LD_A_HLI() {}
	void CPU::LD_A_HLD() {}
	...
	void CPU::op_01() { bc = getBytePair(); }
	void CPU::op_02() { mmu->setU16(bc, getRegisterA()); }
	void CPU::op_03() { bc++; }
	void CPU::op_04() { setRegisterB(getRegisterB() + 1); }
	void CPU::op_05() { setRegisterB(getRegisterB() - 1); }
	void CPU::op_06() { /* TODO */; }
	void CPU::op_07() { /* TODO */; }
	void CPU::op_08() { /* TODO */; }
	void CPU::op_09() { /* TODO */; }
